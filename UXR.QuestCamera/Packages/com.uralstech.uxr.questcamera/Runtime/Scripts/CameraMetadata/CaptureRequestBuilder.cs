...
namespace Uralstech.UXR.QuestCamera
{
    ...
    public sealed class CaptureRequestBuilder : CameraMetadata
    {
        public CaptureRequestBuilder(AndroidJavaObject native) : base(native, "android.hardware.camera2.CaptureRequest") { }
